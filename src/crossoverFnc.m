function [ child, crossoverParams ] = crossoverFnc( parent1, parent2,...
...
% SYNTAX:
%
%   [ child, crossoverParams ] =  crossoverFnc( parent1, parent2,...
%                                   sourceIndex, destinIndex,...
%                                   crossoverType, gridMask )
%
% INPUTS:
...
%
%   crossoverParams = [object] structure array containing information
%                   about the execution of the crossover procedure on the 
%                   two input parents
%   
% EXAMPLES:
%   
...
%                   crossoverType = 1;
%
%                   [child,crossoverParams] = crossoverFnc(parent1,...
%                                               parent2,sourceIndex,...
%                                               destinIndex,...
%                                               crossoverType,gridMask);
%
...
parse(p,nargin,parent1,parent2,sourceIndex,destinIndex,crossoverType,...
    gridMask);
...
switch crossoverType
    ...
    case 0
        ...
        if cxSize(1,2) < 1
            ...
            error('No Valid Crossover Sites Exist Between Parents');
...
%% Write Crossover Parameter Object

if exist('cxSel1','var')
    crossoverSites = vertcat(cxSel1,cxSel2);
else 
    crossoverSites = cxSel;
end

crossoverParams = struct('crossoverType',crossoverType,'crossoverSites',...
    crossoverSites);
