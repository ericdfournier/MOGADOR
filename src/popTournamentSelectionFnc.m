...
% SYNTAX:
%
%   [ ouputPop ] =  tournamentSelectionFnc( inputPop,...
%                                           tournamentSize,...
%                                           selectionProb,...
%                                           selectionType,...
%                                           objectiveVars )
...
%                       objectiveVars);
% 
%                       [outputPop] = tournamentSelectionFnc(inputPop,...
...
selectMsg = {[  'While selectionType = 0, tournamentSize must be less ',...
                'than or equal to the number of individuals in the ',...
                'input population divided by 2'],...
             [  'Tournament Size Must be Less than or Equal to One ',...
                'Half the Number of Individuals in the Input',...
                'Population While selectionType = 0']};

%% Error Checking 

if selectionType == 0 && tournamentSize > n(1,1)/2
    
    disp(selectMsg{selectionType});
    
else
    
    error(selectMsg{selectionType});
